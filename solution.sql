...
-- account balance of 0.00 and a transactions_attempted of 0. Give them a new
-- account balance of 10.00.
UPDATE syntax_practice SET account_balance = '10.00' WHERE
transactions_completed = 0 AND account_balance = 0;
...
transactions_attempted, account_balance) VALUES ('John', 'Bloomington', 7, 2, 350000);
